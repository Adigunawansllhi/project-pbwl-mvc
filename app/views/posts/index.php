      ...
      <tbody>
            ...
            foreach ($data['rows'] as $row) { ?>
                  <tr>
                        ...
                        <td class="d-flex">
                              <a href="<?php echo URL; ?>/posts/edit/<?php echo $row['gol_id']; ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                              <a href="<?php echo URL; ?>/posts/delete/<?php echo $row['gol_id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="fas fa-trash"></i></a>
                        </td>
                  </tr>
            <?php $no++;
            } ?>
